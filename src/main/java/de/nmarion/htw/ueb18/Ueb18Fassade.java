...
public class Ueb18Fassade {
	...
	public void aufgabe_h_iii(Lager lager, String gesuchterAutor) {
		lager.applyToSomeArticles(a -> a instanceof Buch && ((Buch) a).getAutor().equals(gesuchterAutor),
				a -> a.aenderePreis(-5));
	}
	...
	public Artikel[] aufgabe_h_vi(Lager lager, String gesuchterAutor, double minPreis, double maxPreis) {
		List<Artikel> list = lager.filterAll(artikel -> artikel.getPrice() >= minPreis,
				artikel -> artikel.getPrice() <= maxPreis);
