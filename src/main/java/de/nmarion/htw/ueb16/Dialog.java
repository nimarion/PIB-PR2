    ...
    public void readInput() {
        try (final Scanner scanner = new Scanner(System.in, "UTF-8")) {
            while (true) {
                ...
                if (numberCruncher == null && (!input.equalsIgnoreCase("füllen") && !input.equalsIgnoreCase("stop"))) {
        ...
        try {
            switch (input) {
                case "operation":
                    ...
                    System.out.println("Auswählbare Operationen: Sum, Swirl, Divide, Subtract, Average, *Ende*\n");
                    while (true) {
